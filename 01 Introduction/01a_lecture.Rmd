...
- The course is scheduled from Monday (24th of March) to Friday (28th of March) from 2pm to 6pm Berlin time.
...
- We would recommend to download the whole repository from GitHub (https://github.com/jmsigner/movement_workshop_winter_2025)^[If you are familiar with git, feel free to clone the repository]. 
...
```{r, echo = FALSE, out.width="85%", fig.cap=""}
knitr::include_graphics(here::here("img/track_burst.png"))
```
...
```{r, echo = FALSE, out.width="85%", fig.cap=""}
knitr::include_graphics(here::here("img/Hofmann2024.png"))
```
