...
- We would recommend to download the whole repository from GitHub (https://github.com/jmsigner/movement_workshop_spring2025)^[If you are familiar with git, feel free to clone the repository]. 
