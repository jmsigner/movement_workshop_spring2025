...
\phantomsection\label{repeating-tasks-in-r}
...
\phantomsection\label{a-slightly-deeper-look-at-r}
\begin{block}{What is a \texttt{tibbles}?}
\phantomsection\label{what-is-a-tibbles}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{what-is-a-list}
...
\phantomsection\label{examples-for-lists}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{functional-programming-in-r}
\begin{block}{What is functional programming?}
\phantomsection\label{what-is-functional-programming}
\begin{quote}
...
\phantomsection\label{the-apply-family}
...
\phantomsection\label{nest-and-unnest}
An example data set
...
\phantomsection\label{lets-come-back-to-our-example}
