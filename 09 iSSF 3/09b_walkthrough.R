...
# ... Global model ----
# This model ignores that we have different individuals.
...
tibble(
  ...
  ggplot(aes(factor(state), est)) + geom_pointrange(aes(ymin = low, ymax = high))


# Plot step_length distributions
x <- 1:2400
bind_rows(
  tibble(x = x, 
